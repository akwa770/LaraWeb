...
<div class="wrapper" id="app">
  ...
  <!-- Navbar -->
    ...
    {{-- <form class="form-inline ml-3"> --}}
      <div class="input-group input-group-sm ml-3 col-sm-2">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="" class="brand-link">
      <img src="./images/logo.png" alt="LaraWeb Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">LaraWeb</span>
    </a>
